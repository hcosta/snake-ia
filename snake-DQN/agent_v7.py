...
class DQNAgent:
    ...
    def _build_model(self):
        # CAMBIO: Arquitectura de la red simplificada según el informe.
        # Entrada (state_size, ej: 11) -> Densa 256 (ReLU) -> Salida (action_size, ej: 3) (lineal)
        model = Sequential([
    ...
    def get_action(self, state):
        if random.random() <= self.epsilon:
            ...
            # Asegurar que el reshape coincide con (1, state_size)
