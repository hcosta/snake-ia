# trainer_v5_parallel.py
# Basado en trainer_v5.py y la lógica de workers de trainer_v5.py.
# Usa DQNAgent de agent_v5_parallel.py (modelo Sequential).
...
from agent_v5_parallel import DQNAgent, AGENT_VERSION, DATA_DIR
import random
