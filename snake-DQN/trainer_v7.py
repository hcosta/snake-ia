...
"""
Versión 7 del Trainer
=====================
* Utiliza agent_v7 y snake_logic_v13.
* CAMBIO: STATE_SIZE es 11.
* CAMBIO: ACTION_SIZE es 3 (recto, izquierda rel, derecha rel).
* CAMBIO: AGENT_VERSION es "7".
* CAMBIO: Hiperparámetros actualizados:
    - Gamma (discount_factor): 0.9
    - Epsilon: Decaimiento lineal.
    - Batch Size: 64
    - Frecuencia de actualización del Target Model: 5 episodios.
* CAMBIO: Lógica para manejar la penalización por estancamiento de snake_logic.
* CAMBIO: Replay se llama después de cada paso si hay suficiente memoria.
"""
import matplotlib as mpl
# CAMBIO: Importar nuevas versiones de agente y lógica
from agent_v7 import DQNAgent, AGENT_VERSION as AGENT_VERSION_FROM_AGENT, DATA_DIR
from snake_logic_v13 import SnakeLogic, SCREEN_WIDTH_LOGIC, SCREEN_HEIGHT_LOGIC, STEP_SIZE_LOGIC, \
...
LEARNING_RATE_DQN_DEFAULT = 0.0005  # Mantenido como en el informe
DISCOUNT_FACTOR_DQN_DEFAULT = 0.9   # CAMBIO: Alineado con el informe
EPSILON_START_DQN_DEFAULT = 1.0     # Mantenido
# CAMBIO: Tasa de decaimiento lineal por episodio (ej: decae en ~800 episodios de 1.0 a 0.01)
# (1.0 - 0.01) / 800 = 0.99 / 800 = 0.0012375
# Ajustar según el número de episodios objetivo
EPSILON_LINEAR_DECAY_DEFAULT = 0.00125
EPSILON_MIN_DQN_DEFAULT = 0.01      # Mantenido

# Reducido para pruebas más rápidas, informe no especifica. Considerar 20k-1M
REPLAY_MEMORY_SIZE_DQN_DEFAULT = 100_000
BATCH_SIZE_DQN_DEFAULT = 64         # CAMBIO: Aumentado
AGENT_EPOCHS_PER_REPLAY_DEFAULT = 1  # Mantenido
UPDATE_TARGET_EVERY_DEFAULT = 5     # CAMBIO: Actualizar menos frecuentemente

MODEL_FILENAME_BASE_DEFAULT = "dqn_snake_checkpoint"
# Aumentado ligeramente para dar más tiempo con decaimiento lineal
NUM_EPISODES_DEFAULT = 2000
SAVE_CHECKPOINT_EVERY_DEFAULT = 200  # Ajustado
...
def play_mode_with_ui(model_keras_path_full, num_episodes_to_play, play_speed_ui):
    try:
        ...
        from snake_ui_v12 import SnakeGameUI
    ...
    agent_for_playing = DQNAgent(state_size=STATE_SIZE, action_size=ACTION_SIZE,
                                 ...
                                 learning_rate=0.0000001)  # LR no es crucial para jugar
