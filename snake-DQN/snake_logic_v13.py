...
# Recompensa por movimiento normal (puede ser ligeramente negativa para incentivar rapidez)
REWARD_MOVE_LOGIC = .1  # premiar cuanto más tiempo viva la serpiente
# CAMBIO: Nueva recompensa por estancamiento/bucle.
...
class SnakeLogic:
    ...
    def setup(self):
        ...
        # Calcula la posición inicial de la cabeza en el centro del tablero.
