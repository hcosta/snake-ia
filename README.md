# Snake IA: De Q-Learning a Deep Q-Learning Evolutivo

> Un día me aburría y entrené una IA (para jugar Snake). ¡Y la cosa se puso muy interesante, con varias versiones y lecciones aprendidas!

<table>
  <tr>
    <td align="center">Q-Learning en Acción</td>
    <td align="center">Deep Q-Learning (Versión Reciente) en Acción</td>
  </tr>
  <tr>
...
* **Entrenamiento y Rendimiento**: Tras unos 200,000 episodios (aprox. 4 horas), el agente Q-Learning se estancó con una **puntuación media de 25 puntos**, con picos ocasionales cercanos a 40. 
...
<p align="center">
  <img src="./docs/demo-QL-Log.gif" alt="Visualización del agente QL en modo juego (sin entrenamiento)"/>
...
* **Hitos y Aprendizajes por Versión (Resumen)**:
    ...
    * **Versión 7 ("Alineación con Investigación y Mejoras Drásticas")**:
        ...
        * **Resultados**: Estos ajustes produjeron una **mejora muy significativa**. El agente comenzó a mostrar un aprendizaje mucho más rápido y eficiente. Por ejemplo, tras unos 1000 episodios de entrenamiento en esta configuración, el agente ya alcanzaba una **puntuación media de alrededor de 25 puntos**, una mejora drástica en comparación con las decenas de miles o cientos de miles de episodios que se necesitaban antes para progresos menores o con Q-Learning para conseguir los mismos resultados. *(Nota: Los resultados específicos pueden variar entre ejecuciones y ajustes finos)*.
...
<p align="center">
  <img src="./docs/demo-DQN-Log.gif" alt="Visualización del agente DQN v7 en modo juego (sin entrenamiento)"/>
  <em>Visualización del agente DQN (versión reciente) en modo juego.</em>
</p>
...
* **Limitaciones de Recursos y Escala**:
    * Alcanzar el rendimiento de modelos entrenados a gran escala (con millones o miles de millones de interacciones, como se ve en investigaciones con grandes recursos computacionales) es un desafío significativo para proyectos personales. La disponibilidad de GPUs potentes y el tiempo de entrenamiento son factores limitantes.
...
3.  **Ejecutar el Agente Q-Learning (Ejemplo):**
    ```bash
    cd snake-QL
    pipenv runpython trainer_v2.py --play --play-speed=0.02 
    ```

4.  **Ejecutar el Agente DQN (Versión 7 o la más reciente):**
    ```bash
    cd snake-DQN
    pipenv runpython trainer_v7.py --play --play-speed=0.02
    ```

5.  **Jugar al Snake Manualmente (sin IA):**
